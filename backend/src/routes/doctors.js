...
// GET /api/doctors
// FIX: Replaced $queryRawUnsafe with safe Prisma ORM query — SQL injection eliminated
...
// FIX: Replaced sequential awaits with Promise.all — all queries run in parallel
